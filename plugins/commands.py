...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⭕️ Support ⭕', url='https://t.me/+Qqjm_YjQ09ViZWQ1'),
            InlineKeyboardButton('⭕ Channel ⭕️', url='https://t.me/mkv_rockers')
        ],
        [
            InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/+Qqjm_YjQ09ViZWQ1')
        ]
        ]
    await client.send_cached_media(
        chat_id=message.from_user.id,
