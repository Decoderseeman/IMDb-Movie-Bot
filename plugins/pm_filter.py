...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/mkv_rockers'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/+Qqjm_YjQ09ViZWQ1')
            ],
            [
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates ⭕', url='https://t.me/mkv_rockers'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/mkvrequestroom)
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Movies Channel', url='https://t.me/mkv_rockers')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Movie", url="https://t.me/mkv_rockers"),
        InlineKeyboardButton("Series ⭕️", url="https://t.me/+Qqjm_YjQ09ViZWQ1")
    ])
    btn.insert(0, [
